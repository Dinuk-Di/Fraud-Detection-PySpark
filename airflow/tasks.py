...
def extract_window_data(**context):
    ...
    try:
        ...
        ti.xcom_push("window_start", str(window_start))
        ti.xcom_push("window_end", str(window_end))
        ti.xcom_push("total_ingress_count", total_count)
        ti.xcom_push("total_ingress_amount", total_amount)
